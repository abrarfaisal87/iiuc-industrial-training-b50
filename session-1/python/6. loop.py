...
temperatures = [22, 25, 30, 18, 35, 40, 28]
threshold = 30
...
for product, details in products.items():
    ...
    if stock < min_required:
        print(f"Alert: {product.capitalize()} stock is low! Only {stock} in stock. Restock required.")
    else:
        print(f"{product.capitalize()} stock is sufficient. {stock} in stock.")
